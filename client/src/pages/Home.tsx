    ...
    return (
      <div className="px-12 py-8">
        ...
        <SettingsModal
          ...
          statusOptions={statusOptions}
          onStatusOptionsChange={(opts) => {
            if (selectedTeam?.id && effectiveWorkspaceId) {
              dispatch(setStatusOptionsSlice({ teamId: selectedTeam.id, workspaceId: effectiveWorkspaceId, options: opts }));
            }
          }}
        />
      </div>
